    ...
    class ContactConsole
    {
        ...
        public void Menu()
        {
            ...
            while (flag != 0)
            {
                ...
                {
                    case "add": store.Add(ContactDetails());
                        break;

                    case "display": Display(store.ContactList);
                        break;
                    ...
                    case "update": Console.WriteLine("Ënter the name you want to update");
                        store.Update(Console.ReadLine());
                        break;

                    case "remove": store.Remove(Console.ReadLine());
                        Display(store.ContactList);
                        break;

                    case "exit": store.Serialize();
                        flag = 0;
                        break;
